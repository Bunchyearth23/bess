...
- Current technical delivery: the v0.9.0 public Windows downloads contain the application and instructions only; test vehicles, sound banks, projects, and prepared BeamNG add-ons are excluded. Twelve original Automation vehicles and twelve selectable add-ons remain installed locally. Cerberus alone now has the R7 source-guided candidate; the other eleven add-ons remain R6. The user found R6 intake/artificial mechanics unsatisfactory and has not listened to R7 in BeamNG yet. A local app-only R7 preview is available. See the [fleet and release report](reports/BESS-0.9.0-RELEASE-2026-09-23.md) and [resynthesis analysis](reports/BESS-SOURCE-GUIDED-RESYNTHESIS-2026-09-23.md).
...
| X-008 | open | P1 | User heard R6's added intake as artificial; an exhaust-only recording cannot identify the real engine-bay/intake sound | Evaluate the source-guided Cerberus candidate in BeamNG; independent intake/engine recordings remain the route to source-accurate detail |
