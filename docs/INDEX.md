...
- Current technical delivery: the v0.9.0 public Windows downloads contain the application and instructions only; test vehicles, sound banks, projects, and prepared BeamNG add-ons are excluded. Twelve original Automation vehicles and twelve selectable add-ons remain installed locally. Cerberus has the R7 source-guided candidate; the other eleven add-ons remain R6. After listening in BeamNG, the user found R7 metallic and still too close to Automation. A technically verified R8 procedural Cerberus candidate is available locally but has not been accepted or installed. See the [fleet and release report](reports/BESS-0.9.0-RELEASE-2026-09-23.md), [R7 analysis](reports/BESS-SOURCE-GUIDED-RESYNTHESIS-2026-09-23.md) and [R8 experiment](reports/BESS-PROCEDURAL-ENGINE-R8-2026-09-23.md).
