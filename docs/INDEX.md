...
- Current technical delivery: v0.10.0 adds six sound characters and makes descriptor-guided procedural sound the default for new imports, while saved projects retain their selected mode. Twelve new selectable BESS add-ons are installed locally beside twelve unchanged Automation vehicles; the previous add-ons are backed up. The portable and standalone public assets contain the application and English instructions only, without vehicle files. This is technically verified but awaits the user's BeamNG listening verdict. See the [0.10.0 fleet report](reports/BESS-0.10.0-FLEET-2026-09-23.md), [R7 analysis](reports/BESS-SOURCE-GUIDED-RESYNTHESIS-2026-09-23.md) and [R8 experiment](reports/BESS-PROCEDURAL-ENGINE-R8-2026-09-23.md).
