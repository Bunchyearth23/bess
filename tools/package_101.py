"""Build the application-only BESS 0.10.1 Windows release.
...
DIST = ROOT / "dist"
FOLDER = DIST / "BESS-0.10.1-public"
ARCHIVE = DIST / "BESS-0.10.1-Windows-Portable.zip"
STANDALONE = DIST / "BESS-0.10.1-Windows.exe"
SIDECAR = DIST / "BESS-0.10.1-Windows-Portable.zip.sha256"
EXE_SIDECAR = DIST / "BESS-0.10.1-Windows.exe.sha256"
FILES = ("BESS.exe", "START.html", "README.md", "RELEASE_NOTES_0.10.1.md")
...
<title>BESS 0.10.1 — Windows portable</title>
...
<h1>BESS 0.10.1</h1><p>Bunchy's Engine Synthesis System connects Automation engine sounds to selectable BeamNG.drive configurations.</p>
...
<p><a href="README.md">Project guide</a> · <a href="RELEASE_NOTES_0.10.1.md">Release notes</a> · <a href="SHA256.json">File hashes</a></p>
</html>'''


def main() -> None:
    version = tomllib.loads((ROOT / "Cargo.toml").read_text(encoding="utf-8"))["package"]["version"]
    assert version == "0.10.1", f"Build version is {version}, expected 0.10.1"
    binary = ROOT / "target/release/bess.exe"
    for path in (binary, ROOT / "README.md", ROOT / "RELEASE_NOTES_0.10.1.md"):
    ...
    shutil.copy2(ROOT / "RELEASE_NOTES_0.10.1.md", FOLDER / "RELEASE_NOTES_0.10.1.md")
