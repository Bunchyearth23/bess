"""Build the application and recording-free BESS 0.11.0 Windows packages.
...
DIST = ROOT / "dist"
FOLDER = DIST / "BESS-0.11.0-public"
ARCHIVE = DIST / "BESS-0.11.0-Windows-Portable.zip"
STANDALONE = DIST / "BESS-0.11.0-Windows.exe"
SIDECAR = DIST / "BESS-0.11.0-Windows-Portable.zip.sha256"
EXE_SIDECAR = DIST / "BESS-0.11.0-Windows.exe.sha256"
INSTRUMENT_FOLDER = DIST / "BESS-0.11.0-Standalone-public"
INSTRUMENT_ARCHIVE = DIST / "BESS-0.11.0-Standalone-Windows-Portable.zip"
INSTRUMENT_SIDECAR = DIST / "BESS-0.11.0-Standalone-Windows-Portable.zip.sha256"
FILES = ("BESS.exe", "START.html", "README.md", "RELEASE_NOTES_0.11.0.md")
INSTRUMENT_FILES = (
...
<title>BESS 0.11.0 — Windows portable</title>
...
<h1>BESS 0.11.0</h1><p>Bunchy's Engine Synthesis System connects Automation engine sounds to selectable BeamNG.drive configurations.</p>
...
<p><a href="README.md">Project guide</a> · <a href="RELEASE_NOTES_0.11.0.md">Release notes</a> · <a href="SHA256.json">File hashes</a></p>
</html>'''


def portable_readme() -> str:
    return """# BESS 0.11.0 — Windows portable
...
The separate `BESS-0.11.0-Standalone-Windows-Portable.zip` contains the
recording-free engine instrument and generic presets. It is not required for
the main BESS workflow.

See the [release notes](RELEASE_NOTES_0.11.0.md) for changes and scope. The
...
def main() -> None:
    if sys.argv[1:] not in ([], ["--resume-instrument"]):
        raise SystemExit("Usage: package_110.py [--resume-instrument]")
    resume_instrument = sys.argv[1:] == ["--resume-instrument"]
    version = tomllib.loads((ROOT / "Cargo.toml").read_text(encoding="utf-8"))["package"]["version"]
    assert version == "0.11.0", f"Build version is {version}, expected 0.11.0"
    binary = ROOT / "target/release/bess.exe"
    for path in (binary, ROOT / "README.md", ROOT / "RELEASE_NOTES_0.11.0.md", ROOT / "START_STANDALONE.md"):
    ...
    if resume_instrument:
        ...
        assert sha256(FOLDER / "RELEASE_NOTES_0.11.0.md") == sha256(ROOT / "RELEASE_NOTES_0.11.0.md")
        ...
        shutil.copy2(ROOT / "RELEASE_NOTES_0.11.0.md", FOLDER / "RELEASE_NOTES_0.11.0.md")
