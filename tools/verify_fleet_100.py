"""Check private local BESS 0.10.0 BeamNG exports against their Automation ZIPs.
...
def check(source_dir: Path, output_dir: Path) -> dict:
    ...
    report: dict = {"version": "0.10.0", "vehicles": [], "total_wavs": 0, "total_entries": 0}
    ...
    for source in sources:
        ...
        assert manifest["version"] == "0.10.0" and project["hybrid"]["procedural"] is True, slug
